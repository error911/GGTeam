...
public class FileUtility
{
	...
	public static bool Delete(string fullPath)
	{
		...
		{
			Debug.LogError("Не удалось удалить файл! ошибка:" + ex.Message);
			return false;
		}
	}
	...
	public static bool WriteToFile(string fullPath, string data)
	{
		...
		{
			Debug.LogError("Ошибка! Не удалось сохранить в файл! ошибка -" + ex.Message);
			return false;
		}
	}
	...
	public static bool ReadFromFile(string fullPath, out string data)
	{
		...
		{
			data = null;
			Debug.LogError("FileUtility.cs: Файл для чтения не существует!");
			return false;
		}
		...
		{
			data = null;
			Debug.LogError("FileUtility.cs: Не удалось загрузить из файла! ошибка -" + ex.Message);
			return false;
		}
	}
	#endregion
