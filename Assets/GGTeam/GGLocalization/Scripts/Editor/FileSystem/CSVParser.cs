...
{	
	...
	public static class CSVParser
	{
		...
		public static List<List<string>> Read(string path, char delimiter)
		{
			...
			throw new System.IO.FileNotFoundException("CSV файл не существует!", path);
		}
		...
		internal static List<List<string>> ReadFromString(string csvContent, char delimiter)
		{
			...
			{
				throw new System.ArgumentException("Пустой контент CSV. Не могу прочитать CSV", "csvContent");
			}
