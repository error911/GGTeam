...
namespace GGTeam.SmartMobileCore
{
    ...
    public class Analytics : MonoBehaviour
    {
        ...
        public void Report_LevelStart(int lvlNum)
        {
            if (!use_anilytics) return;
        ...
        public void Report_LevelComplete(int lvlNum, float stars, int score)
        {
            if (!use_anilytics) return;
        ...
        public void Report_LevelFailed(int lvlNum, float stars, int score)
        {
            if (!use_anilytics) return;
        ...
        public void Report_LevelRestart(int lvlNum)
        {
            if (!use_anilytics) return;
        ...
        public void Report_PurchaseComplete(string id, bool complete, double price = 0, string currency = "", string receipt = "")
        {
            if (!use_anilytics) return;
            string report = e_PurchaseComplete + "_" + id;
            //var parameters = new Dictionary<string, object>(2) { { "devId", deviceId }, { "completed", complete.ToString() } };
